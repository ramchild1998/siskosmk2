...
<head>
	<meta charset="UTF-8">
	<title><?php echo $judul_browser;?> - SISKOSMKN2BTM</title>
...
<body class="skin-black">
	...
	<header class="header">
		...
		<nav class="navbar navbar-static-top" role="navigation"  style="background-color: #84bc3c">
			...
			<div class="navbar-right">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu"  style="background-color: #84bc3c">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li>
					<i class="fa fa-clock-o"></i> <span  class="jam"></span><br>	
